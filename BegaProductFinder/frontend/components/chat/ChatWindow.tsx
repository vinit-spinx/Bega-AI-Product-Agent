...
function ChatContent({ showSuggestions = false, onReady }: ChatWindowProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-white">
      ...
      {/* ── Header ────────────────────────────────────────────────────────── */}
      <header className="flex items-center justify-between px-6 py-3.5 border-b border-bega-border-1 bg-white flex-shrink-0">
        <button
          type="button"
        ...
        >
          ...
          <span className="hidden sm:block w-px h-5 bg-bega-border-2" />
          <span className="hidden sm:block text-[11px] text-bega-text-3 tracking-widest uppercase font-medium">
            AI Product Advisor
          </span>
        </button>
      ...
      {isEmpty ? (
        ...
        <div className="relative flex-1 flex flex-col items-center justify-center px-6 pb-12 bg-bega-bg-1">
          ...
          <div className="flex flex-col items-center mb-10 relative z-10">
            ...
            <div className="w-12 h-px bg-bega-border-3 mt-7 mb-7 animate-fade-in" style={{ animationDelay: '90ms' }} />
