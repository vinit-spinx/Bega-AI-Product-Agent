...
{
    /// <inheritdoc />
    public partial class AddRepresentativeTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StateText = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    Provinces = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Representatives", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Representatives_Countries_CountryId",
                        column: x => x.CountryId,
                        principalTable: "Countries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RepresentativeDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RepresentativeDetails_Representatives_RepresentativeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RepresentativeDetails_RepresentativeId",
                table: "RepresentativeDetails",
                column: "RepresentativeId");

            migrationBuilder.CreateIndex(
                name: "IX_Representatives_CountryId",
